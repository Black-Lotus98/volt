...
// Uncomment and update the image imports as needed
...
<template>
    <li class="relative" ref="target">
        <Link
            class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray-1 hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
            href="#" @click.prevent="() => { dropdownOpen.value = !dropdownOpen.value; notifying.value = false }">
        <span :class="!notifying.value && 'hidden'"
